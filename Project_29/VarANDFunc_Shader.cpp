...
glm::vec3 EYE(0.0f, 50.0f, 50.0f), AT(0.0f, 5.0f, 0.0f), UP(0.0f, 1.0f, 0.0f);
...
GLuint VAO_background{}, VBO_background{}, IBO_background{};
std::vector<Vertex_glm> Background_Vertex;
std::vector<unsigned int> Background_Index;
...
bool ShowCube{ true };
GLuint ShowCubeID{};
GLuint CubeMatrixID{}, ConeMatrixID{};
glm::vec3 Cube_Rotation_by_Axis{}, Cone_Rotation_by_Axis{};
glm::vec3 Cube_Rotation_Factor{}, Cone_Rotation_Factor{};
