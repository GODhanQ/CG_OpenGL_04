...
extern GLuint VAO_background, VBO_background, IBO_background;
extern std::vector<Vertex_glm> Background_Vertex;
extern std::vector<unsigned int> Background_Index;
extern GLuint BackgroundTextureID;
extern GLuint TextureUniformID;
extern GLuint UseTextureUniformID;
...
extern bool ShowCube;
extern GLuint ShowCubeID;
extern GLuint CubeMatrixID, ConeMatrixID;
extern glm::vec3 Cube_Rotation_by_Axis, Cone_Rotation_by_Axis;
extern glm::vec3 Cube_Rotation_Factor, Cone_Rotation_Factor;
